			...
			<div class="img col-md-4 col-md-offset-4">
				<div class="login-panel panel panel-default">
					<div class="panel-heading">
						<img class="img-responsive center-block login-logo" src="'.$path_logo.'" alt="logo eyesofreport">
					</div>
	...
	<script type="text/javascript">
		...
		if (window!=top){
			...
			$("body").append('<div class="container"><div class="row">'
							...
							+		'<div class="login-panel panel panel-default">'
							+			'<div class="panel-heading">'
							+				'<img class="img-responsive center-block imb-logo login-logo" src="<?php echo $path_logo; ?>" alt="logo eyesofreport">'
							+			'</div>'
							+			'<div class="panel-body">'
